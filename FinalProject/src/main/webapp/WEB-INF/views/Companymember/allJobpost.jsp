...
<div class="company_warp">
	...
	<div class="content">
		...
		<fmt:formatDate value="${toDay_B}" pattern="yyyy-MM-dd" type="date" var="today"/>
		...
		<fmt:formatDate value="${jobpostList.closing}" pattern="yyyy-MM-dd" var="closing" />
		...
		<c:forEach items="${jobpostList}" varStatus="status">
			<fmt:formatDate value="${jobpost.closing}" pattern="yyyy-MM-dd" var="closing" />
